...
export function CaseForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="bg-transparent p-1 border border-border rounded-md w-10 h-10 cursor-pointer shrink-0"
            />
            <Input
              id="accentColor"
      ...
      <div className="gap-6 grid grid-cols-1 md:grid-cols-3">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className="text-muted-foreground text-xs">слева над заголовком</span>
          </div>
          <input
            ref={logoInputRef}
            type="file"
          ...
          {formData.logo ? (
            <div className="space-y-2">
              <div className="flex items-center gap-4 bg-muted/30 p-3 border border-border rounded-lg">
                <div className="flex justify-center items-center bg-[#1A1A1A] shadow-[inset_0_0_10px_rgba(255,255,255,0.05)] p-2 border border-[#272727] rounded-full w-14 h-14 overflow-hidden shrink-0">
                  <img
                    src={formData.logo}
                    alt="Логотип"
                ...
                <div className="flex flex-col flex-1 gap-1.5 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      className="px-2 h-7 text-destructive hover:text-destructive text-xs"
            ...
            <div className="space-y-2">
              <button
                ...
                onClick={() => logoInputRef.current?.click()}
                disabled={isLogoUploading}
                className="flex flex-col justify-center items-center gap-1.5 p-2 border-2 border-border hover:border-primary/50 border-dashed rounded-lg w-full h-[95px] text-muted-foreground hover:text-foreground text-center transition-colors"
              >
                {isLogoUploading ? (
                  <>
                  ...
                  <>
                    ...
                    <span className="font-medium text-xs">Выбрать логотип</span>
            ...
            >
              {isCoverUploading ? (
                ...
                <>
                  ...
                  <span className="font-medium text-xs">Нажмите для выбора обложки</span>
      ...
      <div className="items-end gap-4 grid grid-cols-1 md:grid-cols-2">
        <div className="space-y-2">
          <Label htmlFor="title">
        ...
        <div className="flex items-end gap-3">
          ...
          <div className="flex flex-shrink-0 items-center gap-1 bg-muted/50 p-1 rounded-lg h-10">
            <button
              type="button"
          ...
          >
            <div className="space-y-3">
              ...
              {currentItems.length === 0 ? (
                <div className="flex flex-col justify-center items-center bg-muted/10 py-10 border-2 border-border border-dashed rounded-xl text-muted-foreground">
...
function DraggableStreamItem({
  ...
  if (item.type === "heading") {
    return (
      <Reorder.Item
        ...
        className="space-y-3 bg-muted/40 p-4 border border-border hover:border-primary/40 rounded-xl transition-colors"
      >
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
  ...
  if (item.type === "card") {
    return (
      <Reorder.Item
        ...
        dragListener={false}
        dragControls={controls}
        className="space-y-3 bg-muted/30 p-4 border border-border hover:border-primary/40 rounded-xl transition-colors"
      >
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2.5">
            ...
            <label className="flex items-center gap-1.5 ml-2 text-muted-foreground text-xs cursor-pointer">
              <input
                type="checkbox"
  ...
  if (item.type === "preview") {
    ...
    return (
      ...
      >
        ...
        <div className="gap-2.5 grid grid-cols-1 md:grid-cols-3">
          <div className="space-y-1 md:col-span-2">
            <Label className="text-muted-foreground text-xs">Заголовок секции</Label>
            <Input
              value={item.title}
              onChange={(e) => onUpdate({ ...item, title: e.target.value })}
        ...
        {item.variant === "slideshow" && (
          <div className="flex items-center gap-3 bg-background/60 p-2.5 border border-border/60 rounded-lg">
            ...
            <div className="flex items-center gap-1.5">
              ...
              />
              <span className="text-muted-foreground text-xs">сек</span>
            </div>
          </div>
        )}
  ...
  return (
    <Reorder.Item
      ...
      dragListener={false}
      dragControls={controls}
      className="space-y-3 bg-muted/20 p-4 border-2 border-primary/20 hover:border-primary/40 rounded-xl transition-colors"
    >
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          <span className="flex justify-center items-center bg-primary/10 rounded-full w-6 h-6 font-medium text-primary text-xs">
      ...
      <div className="space-y-2.5 bg-background/50 p-3 border border-border/60 rounded-lg">
        <div className="gap-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {item.cards.map((metric, mIndex) => (
            <div
              key={metric.id || mIndex}
              className="group/metric relative space-y-2 bg-background p-3 border border-border rounded-lg"
            >
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  >
                    <SelectTrigger className="bg-muted/40 px-1.5 w-16 h-6 text-[11px]">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                  ...
                  <button
                    ...
                    className="hover:bg-destructive/10 p-1 rounded text-muted-foreground hover:text-destructive transition-colors"
                  >
        ...
        <Button
          ...
          className="border-dashed w-full h-8 text-xs"
        >
          <Plus className="mr-1.5 w-3.5 h-3.5" />
